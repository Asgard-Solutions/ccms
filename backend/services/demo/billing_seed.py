...
async def _seed_invoices_and_statements(
    ...
    if aria:
        ...
        db_coroutines.append(db.statements.insert_one({
            ...
            "generated_by": refs["billing_user_id"],
            "as_of_date": _iso_ts_ago(5)[:10],
            "total_balance_cents": 12500,
            "balance_cents": 12500,
            "invoice_count": 1,
            "invoice_breakdown": [{"invoice_id": iid, "balance_cents": 12500}],
            "status": "ready",
            "invoice_ids": [iid],
            "body": encrypt_text(
    ...
    if jax:
        ...
        db_coroutines.append(db.statements.insert_one({
            ...
            "generated_by": refs["billing_user_id"],
            "as_of_date": _iso_ts_ago(30)[:10],
            "total_balance_cents": 6000,
            "balance_cents": 6000,
            "invoice_count": 1,
            "invoice_breakdown": [{"invoice_id": iid, "balance_cents": 6000}],
            "status": "ready",
            "invoice_ids": [iid],
            "body": encrypt_text(
